...
export class User {
  ...
  //   }
  //   console.log("User, debug add to watchlist", item_to_add);
  //   let temp = getFinancialAsset(
  //     item_to_add.symbol,
  //     item_to_add.type,
  //     item_to_add.tracker
  //   );
  //   console.log("User, debug add to watchlist", temp);
  //   // remove duplicates
  //   // update firebase
  //   if (this.watchlist) {
  //     console.log('zebi', this.watchlist)
  //     this.watchlist = this.watchlist.filter(
  //       (item) => item && item.symbol !== temp.symbol
  //     );
  //     let value = temp.toWatchlist();
  //     console.log(value);
  //     this.watchlist.push(value);
  //     console.log("User, debug add to watchlist", this.watchlist);
  //     const userRef = doc(firestore_db, "users", this.uid);
  //     updateDoc(userRef, {
  //       watchlist: arrayUnion(temp.toWatchlist()),
  //     })
  //       .then(() => {
  ...
  // }
  // update tracker in this.watchlist
