import { ASSET_TYPES, CURRENCIES } from "./enums";
import { getLatestPrice, useCompanyOverview } from "./getDataFromAPI";
...
export class FinancialAsset {
  ...
  resetTracker() {
    this.tracker = "is this it?";
    this.toWatchlist();
  }
  toWatchlist() {
    console.log("to wach list", this.symbol, this.type, this.tracker);
    return { symbol: this.symbol, type: this.type, tracker: this.tracker };
  }
